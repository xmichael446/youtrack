...
const NavItem = ({
  ...
  return (
    <button
      ...
      className={`flex flex-col md:flex-row items-center justify-center md:justify-start px-2 py-2 md:px-4 md:py-2 w-full md:w-auto rounded-card transition-all duration-normal group relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2 dark:focus-visible:ring-offset-surface-dark-primary
        ${isActive

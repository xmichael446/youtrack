    ...
    return (
        <div className={`h-dvh w-full flex flex-col items-center justify-center p-4 transition-colors duration-500 relative overflow-hidden font-sans ${isDark ? 'bg-surface-dark-primary text-text-theme-dark-primary' : 'bg-surface-secondary text-text-theme-primary'}`}>
            ...
            <div className="w-full max-w-sm md:max-w-4xl z-10 animate-in fade-in duration-700 ease-out">
                <div className={`backdrop-blur-2xl border rounded-card md:rounded-[32px] shadow-2xl relative overflow-hidden transition-all duration-500 ${isDark ? 'bg-surface-dark-secondary/50 border-transparent shadow-black/40' : 'bg-surface-primary/85 border-surface-secondary/60 shadow-black/8'}`}>
                            ...
                            {authStep === 'login' && (
                                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                                    <div>
                                        ...
                                        <div className="relative group/input">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                <User className={`w-[18px] h-[18px] transition-colors duration-normal ${isDark ? 'text-text-theme-dark-muted group-focus-within/input:text-brand-primary' : 'text-text-theme-muted group-focus-within/input:text-brand-primary'}`} />
                                            </div>
                                            <input
                                                type="text"
                                                ...
                                                className={`w-full border-2 text-body rounded-card pl-11 pr-4 py-4 focus:outline-none transition-all duration-normal font-mono ${isDark
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isLoading}
                                        className="w-full bg-gradient-to-r from-brand-primary to-brand-accent text-white py-4 rounded-card font-bold text-sm shadow-xl shadow-brand-primary/20 hover:shadow-brand-primary/35 hover:scale-[1.02] active:scale-[0.98] transition-all duration-fast flex items-center justify-center gap-3 disabled:opacity-50 disabled:scale-100 disabled:shadow-none uppercase tracking-widest font-mono"
                                    >
                                        {isLoading ? (
                                            <>
                            ...
                            {authStep === 'polling' && authData && (
                                <div className="space-y-6 relative z-10 flex flex-col items-center py-4">
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-[#2AABEE] text-white py-4 rounded-card font-bold text-body shadow-xl shadow-[#2AABEE]/25 hover:bg-[#229ED9] hover:scale-[1.02] active:scale-[0.98] transition-all duration-fast flex items-center justify-center gap-2 uppercase tracking-widest font-mono"
                                    >
